 ...
 <tr>
  <td>
   <table cellpadding="0" cellspacing="0" width="960" height="318" border='0'>
    <tr>
     <td background="https://www.vipreantivirus.cz/img2012/VPC-dl-background.png" style="background-repeat:no-repeat">
      <form method="post">
       ...
       <table cellpadding="0" cellspacing="0" border="0" width='100%'>
        <tr>
         <td width="270">&nbsp;</td>
         <td>
          <h3 style="color:#21629c;font-size:24px;font-weight:normal;">Download VIPRE Antivirus 2015</h3><br>
          ...
          <table width='100%' border='0' style="margin-top:10px;">
           <tr>
            ...
            <td style="vertical-align:top;" id="td">
             <input type="submit" name="btnSubmit" value="Stáhnout VIPRE Antivirus" style="margin-left:15px;margin-top:-4px;padding:0 25px 0 25px;" class="btn green">
            </td>
           </tr>
          </table>
         </td>
